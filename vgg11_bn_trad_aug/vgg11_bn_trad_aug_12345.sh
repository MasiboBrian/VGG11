...
echo "running model"
python train_network.py --num_epochs 100 --learning_rate 0.001 --weight_decay 0.0001 --seed 12345
...
mkdir -p /home/${STUDENT_ID}/Code/Cluster/vgg11_bn_trad_aug/Results_12345/

rsync --archive --update --compress /disk/scratch/s2089883/vgg11_bn_trad_aug/exp_1/result_outputs /home/${STUDENT_ID}/Code/Cluster/vgg11_bn_trad_aug/Results_12345/
rsync --archive --update --compress /disk/scratch/s2089883/vgg11_bn_trad_aug/exp_1/saved_models/train_model_latest /home/${STUDENT_ID}/Code/Cluster/vgg11_bn_trad_aug/Results_12345/
